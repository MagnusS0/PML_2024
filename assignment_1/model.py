...
def visualize_latent_space(encoded_data, labels, filename="latent_space_visualization.png"):
    encoded_data = encoded_data.numpy()
    labels = labels.numpy()
    plt.figure(figsize=(10, 8))
    scatter = plt.scatter(encoded_data[:, 0], encoded_data[:, 1], c=labels, cmap='tab10', s=5)
